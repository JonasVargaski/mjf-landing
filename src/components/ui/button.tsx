  ...
  'inline-flex items-center gap-2 justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        warning: 'bg-orange-400 text-primary-foreground hover:bg-orange-400/80',
        success: 'bg-green-500 text-primary-foreground hover:bg-green-500/80',
        outline:
          'border border-white bg-black text-white transition-all hover:bg-orange-400 hover:text-white hover:border-orange-400',
        secondary:
